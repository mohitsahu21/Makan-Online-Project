  ...
  return (
   ...
   <Link to="/blogs/single-blog2" > <img  src={blog2} className="card-img-top" id="" alt="..."/> </Link>
    <div className="card-body">
        ...
        <Link to="/blog/single-blog" style={{textDecoration: 'none'}} >  <h5 className="card-title mt-2">New Construction vs. Resale Homes: Making the Right Choice for Your Next Property
</h5> </Link>
