  ...
  return (
   ...
   <Link to="/blogs/single-blog1" > <img  src={blog1} className="card-img-top" alt="..."/> </Link>
    <div className="card-body">
        ...
        <Link to="/blog/single-blog" style={{textDecoration: 'none'}} >  <h5 className="card-title mt-2">The Critical Role of Home Inspections: A Buyer's Guide to Informed Decisions</h5> </Link>
