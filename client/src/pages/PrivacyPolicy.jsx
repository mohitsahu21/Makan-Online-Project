...
<p>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to bharatroofers.com, Jabalpur, Madhya pradesh INDIA 482002.</p>
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to bharatroofers.com, Jabalpur, Madhya pradesh INDIA 482002.
<br></br>
Cookies are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.
Country refers to: Madhya Pradesh, India<br></br>
...
Website refers to bharatroofers.com, accessible from https://bharatroofers.com <br></br>
...
<br></br>
<h5 className='text-black'>Collecting and Using Your Personal Data</h5>
...
We may also collect information that Your browser sends whenever You visit our Service or when You access the Service by or through a mobile device.<br></br><br></br>
<h5 className='text-black'>Tracking Technologies and Cookies</h5><br></br>
...
Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies on TermsFeed website article.<br></br><br></br>
We use both Session and Persistent Cookies for the purposes set out below:<br></br><br></br>
...
Type: Persistent Cookies<br></br>
Administered by: Us<br></br>
Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.<br></br><br></br>
For more information about the cookies we use and your choices regarding cookies, please visit our Cookies Policy or the Cookies section of our Privacy Policy.<br></br> <br></br>
<h5 className='text-black'>Use of Your Personal Data</h5>  <br></br>
The Company may use Personal Data for the following purposes:  <br></br> <br></br>
...
For other purposes: We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services, marketing and your experience. <br></br>  <br></br>
We may share Your personal information in the following situations:  <br></br> <br></br>
...
•	With Your consent: We may disclose Your personal information for any other purpose with Your consent. <br></br> <br></br>
<h5 className='text-black'>Retention of Your Personal Data</h5>  <br></br>  
...
<h5 className='text-black' >Transfer of Your Personal Data</h5> <br></br>  
...
Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis to do so. <br></br><br></br>
<h5 className='text-black'>Disclosure of Your Personal Data</h5> <br></br>

<h5 className='text-black'>Business Transactions</h5> <br></br>
If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.<br></br> <br></br>
<h5 className='text-black'>Law enforcement</h5> <br></br>
Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).<br></br> <br></br>
<h5 className='text-black' >Other legal requirements</h5> <br></br>
The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:<br></br><br></br>
...
•	Protect against legal liability<br></br><br></br>
<h5 className='text-black'>Security of Your Personal Data</h5> <br></br>
The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.<br></br><br></br>
<h5 className='text-black'> Children's Privacy</h5><br></br>
...
If We need to rely on consent as a legal basis for processing Your information and Your country requires consent from a parent, We may require Your parent's consent before We collect and use that information.<br></br><br></br>
...
We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.<br></br><br></br>
<h5 className='text-black'>Changes to this Privacy Policy</h5> <br></br>
...
<h5 className='text-black'> Contact Us</h5><br></br>
If you have any questions about this Privacy Policy, You can contact us: <br></br>
•	By phone number: +918839280515 <br></br>
