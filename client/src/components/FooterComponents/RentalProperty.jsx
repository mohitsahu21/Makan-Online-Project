...
export default function RentalProperty() {
  ...
  const getAllProperties = async () => {
    try {
      const response = await axios.get(`https://bharatroofers.com/api/property/getPropertyForRentByType/${propertyType}`);
  ...
  return (
    <Wrapper>
      ...
      <div className="mb-4 mt-5 pt-5">
        ...
        <p className="text-uppercase text-center">Available {`${propertyType}s`} For Rent</p>
        </h3>
