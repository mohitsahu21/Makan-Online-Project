...
export default function Flats() {
  ...
  const getAllProperties = async () => {
    try {
      const response = await axios.get(`https://bharatroofers.com/api/property/getPropertyByTypeAndBhk/${propertyType}/${bhk}`);
  ...
  return (
    <Wrapper>
      ...
      <div className="mb-4 mt-5 pt-5">
        ...
        <p className="text-uppercase text-center">Available {`${bhk} Bhk`} {`${propertyType}s`} </p>
        </h3>
